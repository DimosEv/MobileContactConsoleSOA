...
public class MobileContact extends AbstractEntity {
    ...
    public MobileContact(String firstname,
    ...
    public boolean equals(Object other) {
        ...
        that = (MobileContact) other;

        // In Java 17 το παρακάτω κάνει δύο πράγματα
        // 'Ελεγχο αν είναι instanceof και αν ναι μετά κάνει
        // typecast (όπως κάναμε πριν την Java 17 με το παραπάνω κώδικα)
        // if (!(other instanceof MoblileContact that)) return false;)
        return Objects.equals(getFirstname(),
                that.getFirstname()) && Objects.equals(getLastname(),
                that.getLastname()) && Objects.equals(getPhoneNumber(),
                that.getPhoneNumber());
    }
